...
<video controls style={{ width: '100%', height: 'auto' }} src="/assets/images/2024/ai-powered-obsidian/Obsidian_AI_plugins_workflow.mp4" title="Obsidian AI plugins workflow">
  您的浏览器不支持 video 标签。
</video>
