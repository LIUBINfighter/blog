...
<AlphaTabApp client:only="react" initialSource={rawScore} heading="Full Player (AlphaTex)" description="完整功能播放器对同一段 alphaTex 的加载" />
...
### 完整播放器 + Guitar Pro 文件
```tsx
<AlphaTabApp initialSource={{ type: 'url', value: 'https://www.alphatab.net/files/canon.gp', label: 'Canon Demo' }} />
```
