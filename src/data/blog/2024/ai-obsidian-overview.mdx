...
import obsidianSurfingKimi from '@/assets/images/2024/ai-obsidian-overview/Obsidian-Surfing-Kimi.png';
import obsidianSurgingDarkMode from '@/assets/images/2024/ai-obsidian-overview/Obsidian-Surging-DarkMode.png';
import downloadRepoZip from '@/assets/images/2024/ai-obsidian-overview/下载仓库压缩包.png';
import openInObsidian from '@/assets/images/2024/ai-obsidian-overview/使用Obsidian打开本地仓库.png';
import downloadOllama from '@/assets/images/2024/ai-obsidian-overview/DownloadOllama.png';
import winRcmd from '@/assets/images/2024/ai-obsidian-overview/win+R输入cmd运行enter确定.png';
import ollamaList from '@/assets/images/2024/ai-obsidian-overview/ollama_list.png';
import ollamaPull from '@/assets/images/2024/ai-obsidian-overview/ollama_pull_llama3.2_.png';
import viewLocalGptAction from '@/assets/images/2024/ai-obsidian-overview/查看LocalGPTAction.png';
...
<img src={obsidianSurfingKimi} alt="Obsidian-Surfing-Kimi" />

如果你喜欢暗色主题也可以用 Surfing 切换。

<img src={obsidianSurgingDarkMode} alt="Obsidian-Surging-DarkMode" />
...
<img src={downloadRepoZip} alt="下载仓库压缩包" />

解压缩到你想要的位置，通过压缩包下载后解压将不会有 .git 文件夹。如果你会使用 git 则可自行修改仓库名称并添加到 repo。

### 使用 Obsidian 打开

<img src={openInObsidian} alt="使用Obsidian打开本地仓库" style="width: 280px;" />
...
<img src={downloadOllama} alt="DownloadOllama" style="width: 600px;" />

`win+r` 呼出
win+R 输入 cmd 运行 enter 确定
<img src={winRcmd} alt="win+R输入cmd运行enter确定" style="width: 350px;" />
...
<img src={ollamaList} alt="ollama_list" />
...
<img src={ollamaPull} alt="ollama_pull_llama3.2_" />
...
<img src={viewLocalGptAction} alt="查看LocalGPTAction" />
